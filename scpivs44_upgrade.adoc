...
NOTE: Upgrade auf SCV 4.8 wird nur auf VMware vCenter Server 7 Update 1 und höher unterstützt, für VMware vCenter Server vor Version 7 Update 1 sollten Sie weiterhin SCV 4.7 verwenden. Bei nicht unterstützten Versionen des VMware vCenter Servers wird das Upgrade nicht beeinträchtigt.
